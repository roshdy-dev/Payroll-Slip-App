#!/bin/bash
# ============================================================================
#  Payroll Slip Generator - Publish Script (Linux)
#  Creates a self-contained, single-file executable that runs without .NET installed.
# ============================================================================

echo ""
echo "╔══════════════════════════════════════════════════╗"
echo "║   Payroll Slip Generator - Publish (Linux)       ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "   Make executable: chmod +x $OUTPUT_DIR/PayrollSlipGenerator"
echo "   This file can be distributed and run on ANY Linux"
